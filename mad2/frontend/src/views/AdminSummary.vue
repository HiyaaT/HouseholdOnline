<template>
    <div class="container py-5">
      <div class="row justify-content-center">
        ...
        <div class="col-md-6 col-lg-5 mb-4">
          <div class="card h-100">
            <div class="card-body d-flex flex-column">
              <h3 class="card-title text-center">User Distribution</h3>
        ...
        <div class="col-md-6 col-lg-5 mb-4">
          <div class="card h-100">
            <div class="card-body d-flex flex-column">
              <h3 class="card-title text-center">Service Request Status</h3>
  ...
  const fetchDataAndRenderCharts = async () => {
    try {
      const response = await fetch(`${backendURL}/api/v1/user_count`, {
        method: 'GET',
        headers: {
      ...
      const response1 = await fetch(`${backendURL}/api/v1/status_count`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Access-Control-Allow-Origin': '*',
